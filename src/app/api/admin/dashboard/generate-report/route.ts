...
export async function POST(request: Request) {
    try {
        ...
        const baseInclude = {
            ...
            granthas: {
                include: {
                    author: reportOptions.authorBasicInfo || reportOptions.authorBio,
        ...
        granthaDecks.forEach((deck, index) => {
            ...
            if (deck.granthas && deck.granthas.length > 0) {
                if (reportOptions.granthaBasicInfo || reportOptions.granthaDescriptions ||
                    reportOptions.authorBasicInfo || reportOptions.authorBio || reportOptions.languageInfo ||
                    ...
                    if (reportOptions.authorBasicInfo) {
                    ...
                    if (reportOptions.authorBasicInfo || reportOptions.authorBio) {
                        ...
                        if (uniqueAuthors.length > 0) {
                            ...
                            uniqueAuthors.forEach(author => {
                                ...
                                if (reportOptions.authorBio && author.bio) {
